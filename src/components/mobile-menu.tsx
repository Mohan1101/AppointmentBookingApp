    ...
    <div className="pt-2 pb-1 md:hidden">
      ...
      >
        <ul className="bg-gray-800 px-4 py-2">
          ...
          <li>
            <Link href="#zigzag" className="flex font-medium w-full text-purple-600 hover:text-gray-200 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>
              What I do
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link href="#appointments" className="flex font-medium w-full bg-purple-600  text-white hover:bg-purple-700 py-2  justify-center" onClick={() => setMobileNavOpen(false)}>
              Book a session
            </Link>
          </li>
